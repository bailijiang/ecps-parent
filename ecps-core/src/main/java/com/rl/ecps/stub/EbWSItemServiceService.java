 ...
 * 2017-05-13T21:01:14.987+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWSItemServiceService", 
                  wsdlLocation = "http://192.168.30.66:8080/ecps-portal/services/publishItem?wsdl",
...
public class EbWSItemServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.30.66:8080/ecps-portal/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWSItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.30.66:8080/ecps-portal/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
