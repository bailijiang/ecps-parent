...
<#assign path="http://192.168.30.66:8080/ecps-portal">
<#assign file_path="http://192.168.30.66:8030/ecps-file">
...
function addCart(){
	...
	if(cookieResult == "no"){
		alert("cookie 被禁用了，请开启cookie，再添加购物车");
		return;
	}
		...
		<div class="product">
			...
			<div class="showPro">
				...
				<div class="small">
					...
					<div class="smallBox">
						<div class="smallList">
							<a class="cloud-zoom-gallery here" title="red" href="${file_path }${item.imgs}" rel="useZoom: 'showImg', smallImage: '../res/img/pic/smallimage.jpg'"><img alt="thumbnail 1" src="../res/img/pic/tinyimage.jpg"></a>
