...
function del(shipAddrId){
	$.ajax({
		url:"${path}/user/login/deleteAddrById.do",
		type: "post",
		dataType:"text",
		data:{
			shipAddrId:shipAddrId
		...
		success:function(responseText){
			/* alert("del success"); */
			window.location.href = "${path}/user/login/toAddr.do";
		},
		error:function(){
			alert("error");
		}
	...
	<div class="r wr profile">
		...
		<div class="confirm">
			...
			<div class="ofc">
				...
				<input type="hidden" id="listCount" name="listCount" value="${fn:length(addrList) }" />
				...
				<form id="jvForm" action="${path }/user/login/saveOrUpdateAddr.do" method="post">
					...
					<li>
						...
						</select><select name="city" id="mycity">
