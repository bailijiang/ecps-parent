...
<div class="frameR"><div class="content">
	...
	<form id="form111" name="form111" action="${path }/brand/updateBrand.do" method="post" enctype="multipart/form-data">
		...
		<div class="edit set">
			...
			<p><label>排序：</label><input type="text" id="brandSort" reg1="^[1-9][0-9]{0,2}$" tip="排序只能输入1-3位数的正整数" name="brandSort" value="${brand.brandSort }" class="text small"/>
				<span class="pos">&nbsp;</span>
			</p>
